        ...
        <div className="text-white py-20 mt-20 sm:mt-32 flex flex-col justify-between min-h-screen">
            <div className="container mx-auto text-center">
                ...
                <p className="text-2xl mb-8 mt-10">Hi, I am <span className="highlight">Bishow</span>, a <span className='bg-gray p-4 rounded-full relative group'>
                        ?
                        <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-32 bg-gray text-sm text-white rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
